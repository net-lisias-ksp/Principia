...
Note that Principia currently targets KSP 1.3.1 and 1.5.1.
...
* Download the [`trappist-1 for principia εὔδοξος.zip`](https://bit.ly/2RrjjkC) file, unzip it, and drop the `Trappist-1 for Principia` folder in the `GameData` folder of your installation of KSP.
