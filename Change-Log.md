...
We have added a simulation of the [TRAPPIST-1](https://en.wikipedia.org/wiki/TRAPPIST-1) extrasolar planetary system as a mini-mod, “[Trappist-1 for Principia]()”.  TRAPPIST-1 is a system of seven tightly coupled Earth-like planets orbiting close to an ultracool dwarf star where *n*-body gravitation plays an important role, so it's an interesting application of Principia.  For example, [this picture](https://imgur.com/2XwQg3W) shows a low-energy transfer from Trappist-1e to Trappist-1f with ballistic capture where the final orbit exhibits resonance with the rest of the system.
