...
std::vector<PlottedIntegrator> Methods() {
  ...
  return {// Order 2
          ...
          SPRK_INTEGRATOR_FSAL(Suzuki1990),
          ...
          // Order 6
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order6A),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order6B),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order6C),
          ...
          // Order 8
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order8A),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order8B),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order8C),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order8D),
          SPRK_INTEGRATOR_FSAL(Yoshida1990Order8E),
